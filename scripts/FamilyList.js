import { useChores } from "./providers/ChoreProvider.js";
import { useFamilyMembers } from "./providers/FamilyProvider.js";
import { useFamilyChores } from "./providers/FamilyChoreProvider.js";
...
export const FamilyList = () => {
  ...
  const render = () => {
    contentTarget.innerHTML = people
      .map((person) => {
        // Find related chore ids
        let relatedChores = peopleChores.filter(
          (pc) => pc.familyMemberId === person.id
        );
